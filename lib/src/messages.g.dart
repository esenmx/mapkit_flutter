...
bool _deepEquals(Object? a, Object? b) {
  ...
  if (a is Map && b is Map) {
    ...
    for (final MapEntry<Object?, Object?> entryA in a.entries) {
      if (!b.containsKey(entryA.key) ||
          !_deepEquals(entryA.value, b[entryA.key])) {
        return false;
      }
    }
    return true;
...
class PlatformAnnotationIcon {
  ...
  static PlatformAnnotationIcon decode(Object result) {
    ...
    return PlatformAnnotationIcon(
      ...
      imagePixelRatio: result[6] as double?,
    );
  }
  ...
  @override
  String toString() {
    return 'PlatformAnnotationIcon(type: $type, markerTintArgb: $markerTintArgb, glyphText: $glyphText, glyphSystemImage: $glyphSystemImage, glyphTintArgb: $glyphTintArgb, imageBytes: $imageBytes, imagePixelRatio: $imagePixelRatio)';
  }
}
