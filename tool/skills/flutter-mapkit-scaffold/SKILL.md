...
- Tap callbacks: `onAnnotationTap` (annotations) and `onTap` (polylines, polygons, circles) support interactive map features. Set `consumeTapEvents: true` on overlays to prevent taps from propagating to the map.
